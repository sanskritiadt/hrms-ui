    ...
    <div>
                ...
                <tbody className="body">
                  {currentEmployees.map((employee) => (
                    <tr key={employee.employeeId}>
                      ...
                      <td>{employee.userName}</td>
                      <td>
                        <button type="button" className="btn btn-outline-info" onClick={() => fetchPayrollDetails(employee.employeeId)}>
                          Payroll
                        </button>
                      </td>
                      <td>
            ...
            <Form.Group controlId="assetType">
              ...
              <div className="d-flex my-2">
                <Form.Control
                  ...
                  style={{ width: "50vh", marginBottom: 0 }}
                />
                <Button onClick={handleSearchByTypeAndStatus} className="mt-0 mx-2">
                  Search
                </Button>
              </div>
            </Form.Group>
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)} centered>
        ...
        <Modal.Body>
          {payrollDetails ? (
            <div>
              <p><strong>Employee ID:</strong> {payrollDetails.empId}</p>
              <p><strong>Salary:</strong> {payrollDetails.salary}</p>
              <p><strong>Bank Name:</strong> {payrollDetails.bankName}</p>
              <p><strong>Designation:</strong> {payrollDetails.designation}</p>
              <p><strong>Join Date:</strong> {payrollDetails.joinDate}</p>
              <p><strong>Account Number:</strong> {payrollDetails.accountNumber}</p>
              <p><strong>IFSC Code:</strong> {payrollDetails.ifscCode}</p>
            </div>
          ) : (
            <p>Loading...</p>
          )}
